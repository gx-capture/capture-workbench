"""Generated from worker-stage-policy.json; do not edit."""

from __future__ import annotations

from typing import Final

WORKER_STAGE_POLICY_SCHEMA_VERSION: Final = "1"
MAX_WORKER_DIAGNOSTIC_STAGES: Final = 32
MAX_WORKER_DIAGNOSTIC_STAGE_LENGTH: Final = 128
...
FAMILY_PATTERNS: Final[tuple[str, ...]] = (
    "ocr-probe-modules-missing-[0-9]{1,3}",
    "ocr-probe-assets-missing-[0-9]{1,4}",
    "ocr-probe-providers-[0-9]{1,6}-cpu-(?:yes|no)-dml-(?:yes|no)",
    "ocr-provider-evidence-dml-[0-9]{1,6}-cpu-[0-9]{1,6}",
    "ocr-(?:pipeline-create|predict|provider-evidence)-failed-(?:arithmeticerror|assertionerror|attributeerror|connectionerror|engineruntimeunavailableerror|eoferror|filenotfounderror|importerror|indexerror|keyerror|memoryerror|modulenotfounderror|nameerror|notexisterror|notimplementederror|ocrexecutionevidenceerror|ocrinferencecleanuperror|oserror|overflowerror|paddleresultnormalizationerror|permissionerror|runtimeerror|timeouterror|typeerror|unknown|unknownexecutionprovidererror|valueerror|zerodivisionerror)",
    "python-import-(?:onnxruntime|paddleocr)-failed-(?:arithmeticerror|assertionerror|attributeerror|connectionerror|engineruntimeunavailableerror|eoferror|filenotfounderror|importerror|indexerror|keyerror|memoryerror|modulenotfounderror|nameerror|notexisterror|notimplementederror|ocrexecutionevidenceerror|ocrinferencecleanuperror|oserror|overflowerror|paddleresultnormalizationerror|permissionerror|runtimeerror|timeouterror|typeerror|unknown|unknownexecutionprovidererror|valueerror|zerodivisionerror)",
    "python-import-(?:onnxruntime|paddleocr)-failed-(?:arithmeticerror|assertionerror|attributeerror|connectionerror|engineruntimeunavailableerror|eoferror|filenotfounderror|importerror|indexerror|keyerror|memoryerror|modulenotfounderror|nameerror|notexisterror|notimplementederror|ocrexecutionevidenceerror|ocrinferencecleanuperror|oserror|overflowerror|paddleresultnormalizationerror|permissionerror|runtimeerror|timeouterror|typeerror|unknown|unknownexecutionprovidererror|valueerror|zerodivisionerror)-(?:missing-module|native-load|cannot-import-symbol|partial-init|other)-(?:onnxruntime|paddleocr|paddlex|unknown)",
    "python-import-(?:onnxruntime|paddleocr)-failed-(?:arithmeticerror|assertionerror|attributeerror|connectionerror|engineruntimeunavailableerror|eoferror|filenotfounderror|importerror|indexerror|keyerror|memoryerror|modulenotfounderror|nameerror|notexisterror|notimplementederror|ocrexecutionevidenceerror|ocrinferencecleanuperror|oserror|overflowerror|paddleresultnormalizationerror|permissionerror|runtimeerror|timeouterror|typeerror|unknown|unknownexecutionprovidererror|valueerror|zerodivisionerror)-native-load-(?:onnxruntime|paddleocr|paddlex|unknown)-(?:dependency-missing|symbol-missing|bad-image|initialization-failed|resource-exhausted|blocked|side-by-side|unknown)-(?:onnxruntime|directml|opencv|numpy|pandas|shapely|pyclipper|pillow|pydantic-core|rpds|tokenizers|chardet|charset-normalizer|aiohttp|multidict|yarl|frozenlist|propcache|vc-runtime|python-runtime|paddlex|paddleocr|unknown)",
    "python-import-(?:engine-adapters|worker-contracts|worker-server)-os-failed-winerror-[0-9]{1,5}",
    "whisper-model-load-(?:cpu|cuda)-failed-(?:arithmeticerror|assertionerror|attributeerror|connectionerror|engineruntimeunavailableerror|eoferror|filenotfounderror|importerror|indexerror|keyerror|memoryerror|modulenotfounderror|nameerror|notexisterror|notimplementederror|ocrexecutionevidenceerror|ocrinferencecleanuperror|oserror|overflowerror|permissionerror|runtimeerror|timeouterror|typeerror|unknown|unknownexecutionprovidererror|valueerror|zerodivisionerror)",
    "worker-process-(?:timeout|exit-before-response|no-response|response-error|exit-nonzero)-bootloader",
)
UNKNOWN_PREFIXES: Final[tuple[tuple[str, str], ...]] = (
    ("ocr-probe-modules-missing-", "ocr-probe-modules-missing-unknown"),
    ("ocr-probe-assets-missing-", "ocr-probe-assets-missing-unknown"),
    ("ocr-probe-providers-", "ocr-probe-providers-unknown"),
    ("ocr-provider-evidence-dml-", "ocr-provider-evidence-unknown"),
    ("ocr-pipeline-create-failed-", "ocr-pipeline-create-failed-unknown"),
    ("ocr-predict-failed-", "ocr-predict-failed-unknown"),
    ("ocr-provider-evidence-failed-", "ocr-provider-evidence-failed-unknown"),
    ("python-import-onnxruntime-failed-", "python-import-onnxruntime-failed-unknown"),
    ("python-import-paddleocr-failed-", "python-import-paddleocr-failed-unknown"),
    (
        "python-import-engine-adapters-os-failed-winerror-",
        "python-import-engine-adapters-os-failed-winerror-unknown",
    ),
    (
        "python-import-worker-contracts-os-failed-winerror-",
        "python-import-worker-contracts-os-failed-winerror-unknown",
    ),
    (
        "python-import-worker-server-os-failed-winerror-",
        "python-import-worker-server-os-failed-winerror-unknown",
    ),
)
...
WORKER_STAGE_STARTUP_HEAD_COUNT: Final = 16
WORKER_STAGE_FAILURE_TAIL_COUNT: Final = 8
