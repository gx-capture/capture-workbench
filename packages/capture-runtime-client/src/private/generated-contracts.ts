...
export const RUNTIME_VERSION = "0.4.2" as const;
...
/** Wire enum. */
export type OcrComputeReasonCode = "no_compatible_gpu" | "dml_provider_unavailable";

/** Wire enum. */
export type OcrPageStatus = "recognized" | "empty" | "failed";

/** Wire enum. */
export type OcrProjectionStatus = "completed" | "failed";

/** Wire enum. */
export type OcrProvenanceStatus = "resolved" | "unavailable";

/** Wire enum. */
export type OcrProvenanceUnavailableReason = "model_unavailable" | "worker_crashed" | "worker_timeout" | "protocol_failure";
...
export interface CaptureOcrProjectionV3 {
  ...
  readonly captureId: string;
  readonly status: OcrProjectionStatus;
  readonly source?: CaptureSource | null;
  readonly pages: readonly (OcrPageProjectionV3)[];
  readonly pageCount: number;
  readonly runtimeVersion: "0.4.2";
  readonly contractSha256: string;
  readonly provenance: OcrProvenanceV3;
  readonly warnings?: readonly (string)[];
  readonly failure?: CaptureFailureV2 | null;
  readonly createdAt: string;
}
...
export interface OcrBoxV3 {
  readonly polygon: readonly (OcrPointV3)[];
  readonly text: string;
  readonly confidence: number | null;
}

export interface OcrComputePreflightV2 {
  readonly apiVersion: "2.0";
...
export interface OcrPageProjectionV3 {
  readonly page: number;
  readonly status: OcrPageStatus;
  readonly raster: OcrRasterV3;
  readonly text?: string;
  readonly boxes?: readonly (OcrBoxV3)[];
  readonly confidence?: number | null;
  readonly provenance: OcrProvenanceV3;
  readonly failure?: CaptureFailureV2 | null;
}

export interface OcrPageScopeV2 {
...
export interface OcrPointV3 {
  readonly x: number;
  readonly y: number;
}

export interface OcrProvenanceResolvedV3 {
...
export interface OcrProvenanceUnavailableV3 {
  readonly status: "unavailable";
  readonly profileId: string;
  readonly profileSpecSha256: string;
  readonly reason: OcrProvenanceUnavailableReason;
}

export type OcrProvenanceV3 = OcrProvenanceResolvedV3 | OcrProvenanceUnavailableV3;

export interface OcrRasterV3 {
  readonly width: number;
  readonly height: number;
  readonly scale: number;
  readonly coordinateSystem: "pixel";
}
...
export interface RawCapture {
  ...
  readonly extractionEngine: CaptureEngine;
  readonly warnings?: readonly (string)[];
  readonly ocrPageScope?: OcrPageScopeV2 | null;
  readonly createdAt: string;
}
...
export interface RuntimeReady {
  ...
  readonly ocrCompute?: OcrComputePreflightV2 | null;
...
export interface StartCaptureV2 {
  ...
  readonly pdfPageNumbers?: readonly (number)[] | null;
}
...
export type CaptureContractName = "CaptureBlock" | "CaptureDocument" | "CaptureEngine" | "CaptureEventV2" | "CaptureFailureV2" | "CaptureOcrProjectionV3" | "CaptureOperationV2" | "CaptureSource" | "CaptureStreamingResult" | "ErrorBodyV2" | "ErrorEnvelopeV2" | "FinalizeIngestionV2" | "IngestionV2" | "OcrBoxV3" | "OcrComputePreflightV2" | "OcrPageProjectionV3" | "OcrPageScopeV2" | "OcrPointV3" | "OcrProvenanceResolvedV3" | "OcrProvenanceUnavailableV3" | "OcrProvenanceV3" | "OcrRasterV3" | "OpenIngestionV2" | "OpenStructuringSessionV2" | "PageLocator" | "PartialCaptureV2" | "RawCapture" | "RawCaptureSegment" | "ReportStructuringFailureV2" | "RuntimeArtifactDescriptorV2" | "RuntimeInstallationV2" | "RuntimeInstallationsV2" | "RuntimeModelInstallationV2" | "RuntimeModelInstallationsV2" | "RuntimeModelOptionV2" | "RuntimeModelOptionsV2" | "RuntimeReady" | "RuntimeRequirementV2" | "RuntimeRequirementsV2" | "RuntimeStreamingCapabilitiesV2" | "StartCaptureV2" | "StartRuntimeInstallationV2" | "StartRuntimeModelInstallationV2" | "StructuringBatchV2" | "StructuringProviderCapabilityV2" | "StructuringSemanticBlockV2" | "StructuringSessionV2" | "SubmitStructuringBatchV2" | "TimeLocator";
...
export const CAPTURE_CONTRACT_INVARIANTS = [
  ...
  },
  {
    ...
    description: "gpu-dml carries no fallback reason or notice; cpu-fallback carries a stable reason and user notice.",
  },
  {
    id: "ocr-compute-preflight-identity",
    models: "OcrComputePreflightV2",
    description: "pre-OCR compute decisions carry API, schema, runtime, contract-set, and exact contract digest identity.",
  },
  {
...
export const CAPTURE_CONTRACT_EXTRA_POLICIES = {
  ...
  "IngestionV2": "forbid",
  "OcrBoxV3": "forbid",
  "OcrComputePreflightV2": "forbid",
  "OcrPageProjectionV3": "forbid",
  "OcrPageScopeV2": "forbid",
  "OcrPointV3": "forbid",
  "OcrProvenanceResolvedV3": "forbid",
  "OcrProvenanceUnavailableV3": "forbid",
  "OcrProvenanceV3": "allow",
  "OcrRasterV3": "forbid",
