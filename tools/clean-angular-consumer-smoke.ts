...
function runPnpm(args, relativeCwd = '') {
  return defer(() => {
    if (!corepackCli) {
      throw new Error(
        'Node 24 Corepack is required to run the pnpm 12 fixture.',
      );
    }
    return run(
      process.execPath,
