...
1. The desktop app is a packaging and clean-install verification harness, not a public desktop product.
...
8. Deterministic package QA is separate from real Windows clean-install evidence. Its fake runtime is a test fixture and cannot satisfy the release gate.
