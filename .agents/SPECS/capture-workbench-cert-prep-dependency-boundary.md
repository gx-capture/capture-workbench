...
dependency of `@gx-capture/capture-workbench-ui`, while removing the unused direct
...
- `@gx-capture/capture-workbench-ui` owns the Angular Elements implementation boundary.
